...
namespace ns3 {
    ...
    protected:
        ...
        std::string m_udp_bursts_performance_csv_filename;
        std::string m_udp_bursts_performance_txt_filename;
        std::string m_algorithm_performance_csv_filename;
        std::string m_algorithm_performance_txt_filename;
