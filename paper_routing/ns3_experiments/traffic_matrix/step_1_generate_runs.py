...
for run in get_run_list():
    ...
    local_shell.sed_replace_in_file_plain(config, "[ISL-MAX-QUEUE-SIZE-KB]", str(run["isl_queue_kB"]))
    local_shell.sed_replace_in_file_plain(config, "[GSL-MAX-QUEUE-SIZE-KB]", str(run["gsl_queue_kB"]))
    local_shell.sed_replace_in_file_plain(config, "[ILL-MAX-QUEUE-SIZE-KB]", str(run["ill_queue_kB"]))
